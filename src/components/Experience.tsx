...
const Experience = () => {
  return (
    <section id="experience" className="py-20 px-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/4 w-24 h-24 bg-gradient-to-br from-teal-400/30 to-cyan-500/30 rounded-full blur-2xl animate-pulse animation-delay-2000"></div>
