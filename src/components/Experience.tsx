...
const Experience = () => {
  return (
    <section id="experience" className="py-20 px-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-20 right-10 w-40 h-40 bg-gradient-to-br from-blue-400/30 to-teal-500/30 rounded-full blur-2xl animate-pulse animation-delay-1000"></div>
      <div className="absolute top-1/2 left-1/4 w-24 h-24 bg-gradient-to-br from-teal-400/30 to-indigo-500/30 rounded-full blur-2xl animate-pulse animation-delay-2000"></div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <Trophy className="text-cyan-400 animate-bounce animation-delay-500" size={40} />
          </div>
          <div className="w-32 h-1 bg-gradient-to-r from-cyan-400 via-blue-400 to-teal-400 mx-auto rounded-full"></div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          {/* Education */}
          <div>
            <h3 className="text-2xl font-semibold text-white mb-8 bg-gradient-to-r from-blue-400 to-teal-400 bg-clip-text text-transparent">Education</h3>
            <div className="bg-gradient-to-br from-slate-800/60 to-slate-900/40 backdrop-blur-sm p-6 rounded-xl border border-slate-700/50 hover:border-blue-400/50 transition-all duration-300 shadow-xl">
              <h4 className="text-xl font-semibold text-white mb-2 bg-gradient-to-r from-blue-400 to-teal-400 bg-clip-text text-transparent">Bachelor of Engineering</h4>
            ...
            <div className="mt-8">
              ...
              <div className="space-y-4">
                <div className="group relative">
                  ...
                  <div className="relative bg-gradient-to-br from-slate-800/60 to-slate-900/40 backdrop-blur-sm p-6 rounded-xl border border-slate-700/50 hover:border-cyan-400/50 transition-all duration-300 shadow-xl">
                    <div className="flex items-start gap-4">
                      <div className="flex-shrink-0">
                        <img 
                          src="/lovable-uploads/5cf2bc37-e8e9-4042-bd58-3013c45ed00f.png" 
                          alt="CHAKRAWAR Certificate"
                          className="w-16 h-16 object-cover rounded-lg border-2 border-cyan-400/50"
                        />
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <Trophy className="text-cyan-400" size={20} />
                          <h4 className="text-cyan-400 font-semibold">🏆 First Prize in 5G Networking Presentation</h4>
                        </div>
                        ...
                        <p className="text-blue-400 text-xs font-medium">CHAKRAWAR Technical Combat - March 2023</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="group relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-400/20 to-teal-400/20 rounded-xl blur-xl opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
