      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-3 mb-4">
            <Briefcase className="text-violet-400 animate-bounce" size={40} />
            ...
            <Briefcase className="text-violet-400 animate-bounce animation-delay-500" size={40} />
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            <div className="absolute left-4 top-0 bottom-0 w-0.5 bg-gradient-to-b from-violet-400 to-purple-400"></div>
            
            <div className="relative pl-12 pb-8">
              <div className="absolute left-2 top-0 w-4 h-4 bg-gradient-to-r from-violet-400 to-purple-500 rounded-full shadow-lg shadow-violet-400/50"></div>
              <div className="bg-gradient-to-br from-slate-800/60 to-slate-900/40 backdrop-blur-sm p-8 rounded-xl border border-slate-700/50 hover:border-violet-400/50 transition-all duration-300 shadow-xl">
                <h3 className="text-2xl font-semibold text-white mb-2 bg-gradient-to-r from-violet-400 to-purple-400 bg-clip-text text-transparent">Junior Associate Developer - Web Development</h3>
                <p className="text-violet-400 mb-2 font-medium text-lg">Stackit Private Limited</p>
