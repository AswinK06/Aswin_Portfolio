...
const Hero = () => {
  ...
  return (
    <section className="pt-24 pb-16 min-h-screen flex items-center justify-center relative px-4 bg-gradient-to-br from-white via-purple-50 to-indigo-100 transition-colors duration-300">
      <div className="text-center text-gray-800 max-w-4xl mx-auto">
        ...
        <div className="flex justify-center gap-6 mb-8">
          <a 
            ...
            className="text-gray-600 hover:text-purple-500 transition-colors duration-300 hover:scale-110 transform"
          >
            <Github size={24} />
          </a>
          <a 
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer" 
            className="text-gray-600 hover:text-orange-500 transition-colors duration-300 hover:scale-110 transform"
          >
          ...
          <a 
            ...
            className="text-gray-600 hover:text-indigo-500 transition-colors duration-300 hover:scale-110 transform"
          >
            <Mail size={24} />
          </a>
        </div>
